...
socketToGui.onmessage = (event) => {
	...
	/*
	else if( event.data.includes("gridRep")) { //"gridRep":[[   INIVIATO nel caso global
		console.log("pageglobal | onmessage RICEVE griRep" );
        const grid = JSON.parse(event.data).gridRep;
